...
const Menu = () => {
  ...
  return (
    <section id="menu" aria-labelledby="menu-heading">
      <img id="m-left-leaf" src="/images/slider-left-leaf.png" alt="left-leaf"/>
      <img id="m-right-leaf" src="/images/slider-right-leaf.png" alt="right-leaf"/>
      ...
      <div className="content">
        ...
        <div className="cocktail">
          <img src={currentCocktail.image} alt={`cocktail-${currentCocktail.id}`} className="object-contain"/>
        </div>
